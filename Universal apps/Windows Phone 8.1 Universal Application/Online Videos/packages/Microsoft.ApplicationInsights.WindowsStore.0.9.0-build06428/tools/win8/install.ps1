...
# get the file item
$config = $project.ProjectItems.Item("ApplicationInsights.config")

# set 'Copy To Output Directory' to 'Copy if newer'
$copyToOutput = $config.Properties.Item("CopyToOutputDirectory")
$copyToOutput.Value = [System.UInt32]2

# set the 'Build Action' to 'Content'
$buildAction = $config.Properties.Item("BuildAction")
$buildAction.Value = [System.UInt32]2

# set the 'Content' property to 'True'
$deploymentContent = $config.Properties.Item("DeploymentContent")
$deploymentContent.Value = [System.UInt32]1


# SIG # Begin signature block
# MIIamQYJKoZIhvcNAQcCoIIaijCCGoYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU85lfF1B17R61Jst9PLFiKVGH
# GAqgghV6MIIEuzCCA6OgAwIBAgITMwAAAFnWc81RjvAixQAAAAAAWTANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT5HXXxdYO5eogJ
# xCIr1puSUINzqDBCBgorBgEEAYI3AgEMMTQwMqAYgBYAaQBuAHMAdABhAGwAbAAu
# AHAAcwAxoRaAFGh0dHA6Ly9taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIB
# AH7YGCH4m7CpGuuQbKSfsfwjk4mu9OrvqYtse1ZVIfiR+dkoGnwVEwedSuf6Nfuy
# tRdtDlIv7kCIzcnYrsgQBVcvkuiMYJMHHrenb+kUPbQewvvqymQLRGs3sRpEnsEn
# Cpzl36VHktJG9ITcucZqjTP3cIzBXAoci4yeZe4hpS9bVyLHVBLIxmWpxZ5evQVS
# IsC2t6deCHOiO9/zzgJImiCTTyiIfwONNUWnxjfGtatuCRv8df9UD7pW8rv98Spw
# kzayW7FYXablUExUAtbKISzRHiVY3dl64M+SK72HZlTzGScD1KWsRQP4+G0JhQ15
# ZxnqkOMoIsM7DiGrHCV4lMihggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEw
...
# DQEJBTEPFw0xNDA2MjcxNDUzMzlaMCMGCSqGSIb3DQEJBDEWBBRZr7bItPHFSE5d
# Wy5tNxyOzkmTYTANBgkqhkiG9w0BAQUFAASCAQC8D9DP/Udtf5OmSSBXp6HQvrHY
# 0TKoaqJguxXDLBoV8goe0b1eh0ivvisO0FmISxcV1fIQTB/GBFZzHM/t4xH9DduC
# g3tUoiWjhOY0JhcTSZKVea0A77A5q/sH7/jNs7c1GAHm8vuS6Z/kelcCLNXKdp4o
# tMp4UOCNIU4CcV6Xbrr2bJGbVs1t3QhOymbhWL+rPS6+IfJWYZ7y3MifUhajfMAY
# 5HJ594vMYF2rabXSXubTU+bNEDxtxYVLGHil2D8GZfiQ+d0VCCCayglYmdG7ouCy
# HdQePfUanljCM6QUhADbS/sfES6nCpz5Yxou2Fn304mcj7kV1fIIcV+RQHwj
