    ...
    public sealed partial class SyncButton : UserControl
    {
        ...
        private async void SignInClick(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                LiveLoginResult authResult = Task.Run(async () => await authClient.LoginAsync(scopes)).Result;
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (signIn)
                    {
                        ...
                        loginResult = await LCAuth.LoginAsync(new string[] { "wl.basic wl.offline_access wl.skydrive_update" });
                    }
                    else
                    {
