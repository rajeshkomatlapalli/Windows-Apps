...
namespace OnlineVideos.Library
{
    ...
    public class ShowDownloadForBlogs
    {
        ...
        public void StartDownload()
        {
            ...
            {
                if (!String.IsNullOrEmpty(AppSettings.Secondaryshowsfromblog) && AppSettings.Secondaryshowsfromblog!="false")
                {
                    try
                    {
            ...
            {
                if (!String.IsNullOrEmpty(AppResources.PrimaryShowsDownloadUri) && AppResources.PrimaryShowsDownloadUri!="false")
                {
                    ReadRss(new Uri(AppResources.PrimaryShowsDownloadUri, UriKind.Absolute));
# if WINDOWS_PHONE_APP || ANDROID
                    auto.WaitOne();
#endif
                }
