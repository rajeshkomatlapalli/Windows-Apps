...
namespace OnlineVideos.Views
{
    ...
    /// </summary>
    public sealed partial class StoryTimeFavorite : Page
    {
        ShowLinks desToSelect = new ShowLinks();
        public StoryTimeFavorite()
        {
            this.InitializeComponent();
            Loaded += StoryTimeFavorite_Loaded;
        }

        private void StoryTimeFavorite_Loaded(object sender, RoutedEventArgs e)
        {
            LoadAds();
        ...
        private void LoadAds()
        {
            ...
            {
                Exceptions.SaveOrSendExceptions("Exception in Loadads Method In StoryTimeFavorite file", ex);
                string excepmess = "Exception in LoadAds Method In StoryTimeFavorite file.\n\n" + ex.Message + "\n\n StackTrace :- \n" + ex.StackTrace;
            }
