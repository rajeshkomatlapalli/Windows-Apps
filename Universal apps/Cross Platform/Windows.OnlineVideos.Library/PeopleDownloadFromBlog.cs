    ...
    public class PeopleDownloadFromBlog
    {
        ...
        public void StartDownload()
        {
            if (AppSettings.BlogStatus == 0)
            {
                ...
                { 
#endif
                if (!String.IsNullOrEmpty(AppSettings.Secondarypeoplefromblogwin81))
                {
...
#endif
                    ReadRss(new Uri(AppSettings.Secondarypeoplefromblogwin81, UriKind.Absolute));
            ...
            else
            {
                ...
                { 
#endif
                if (!String.IsNullOrEmpty(AppSettings.Primarypeoplefromblogwin81))
                {
#if WINDOWS_PHONE_APP
                    ReadRss(new Uri(AppSettings.Primarypeoplefromblog, UriKind.Absolute)); 
#endif
                    ReadRss(new Uri(AppSettings.Primarypeoplefromblogwin81, UriKind.Absolute));
#if WINDOWS_PHONE_APP || ANDROID
                    auto.WaitOne();
#endif
            ...
            try
            {
               ...
               // var currentFeed = SyndicationFeed.Load(response).Items;
...
#endif
                {
                    ...
                    if ((DateTimeOffset)f.PublishedDate.Date > AppSettings.PeopleLastUpdatedDate.Date)                    
                    #endif
                    {
                        if (ttitle == "")
